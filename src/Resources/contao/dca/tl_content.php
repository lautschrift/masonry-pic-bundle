...
/* Palettes */
$GLOBALS['TL_DCA'][$strName]['palettes']['masonrypic'] = '{type_legend},type,headline;{description_legend},ls_masonry_properties,ls_masonry_link;{source_legend},singleSRC;{invisible_legend:hide},invisible,start,stop;';
