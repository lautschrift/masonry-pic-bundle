...
/* Palettes */
$GLOBALS['TL_DCA'][$strName]['palettes']['masonrypic'] = '{type_legend},type,headline;{source_legend},singleSRC;{description_legend},ls_masonry_properties,ls_masonry_link;{invisible_legend:hide},invisible,start,stop;';
